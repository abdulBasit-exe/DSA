...
// not exist in the table.
    ...
    public void changeKey(Object key,Object changeKey,Object value){
        if (containsKey(key)) {
            remove(key);
            put(changeKey, value);
        }
...
class TestHashTable{
    ...
    public static void main(String[] args){
        ...
        String key,value,changeKey;

        while (true) {

            System.out.println("\nMenu:");

            System.out.println(" 1. Add a (Name,Contact)");

            System.out.println(" 2.  get(Name,Contact)");

            System.out.println(" 3.Search (Name)");

            System.out.println(" 4. Delete(Name)");

            System.out.println(" 5. show complete Names and Contact .");
            System.out.println("6 update the Name And Contact :");
            ...
            switch (textIO.nextInt()) {
                ...
                case 2:
                    ...
                    System.out.println(" Contact is " + table.get(key));
                ...
                case 3:
                    ...
                    System.out.println(" Name is:(" + key + ") is "
                ...
                case 6:
                    ...
                    changeKey = textIO.next();

                    System.out.print("");

                    System.out.print("  change Contact = ");

                    value = textIO.next();

                    table.changeKey(key,changeKey,value);
                    break;
                case 7:
